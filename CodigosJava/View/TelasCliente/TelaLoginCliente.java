...
public class TelaLoginCliente {
	...
	public TelaLoginCliente(boolean ligaTela,String size) throws MalformedURLException{
		...
		labelLogin = criaLabel(barraLogin.getWidth()/2+-50, 10, 250, 30, "labelLogin" , "Login Cliente");
		...
		botaoLogin = criaBotao(frame.getWidth()/2-frame.getWidth()/8+-12, frame.getHeight()/2+frame.getHeight()/3,280,40,"botaoLogin", "Entrar");
		//Adiciona os campos em um painel
					...
					evento =new java.awt.event.MouseAdapter() {
						    ...
						    public void mouseClicked(java.awt.event.MouseEvent evt) {
								...
								if(ok==true) {
									...
									if(login.loginCliente(campoNome.getText(), campoSenha.getText())) {
										JOptionPane.showMessageDialog(null, "Fez Login Com sucesso");
										clienteTela=login.pegaCliente(campoNome.getText(), campoSenha.getText());
								    	frame.dispose();
...
//			cria e usa uma variável que altera o eixo x de forma dinâmica
			int localizacaoX3 = (barraLogin.getWidth() - (barraLogin.getWidth()/8) ) /2;
...
//			cria e usa uma variável que altera o eixo x de forma dinâmica
			...
			botaoLogin.setLocation(frame.getWidth()/2-frame.getWidth()/8+-12, frame.getHeight()/2+frame.getHeight()/3);
			barraLogin.setBounds(frame.getWidth()/2-frame.getWidth()/4,30,frame.getWidth()/2,50);
			labelLogin.setLocation(barraLogin.getWidth()/2+-50, 10);
			maximo.setText("□");
			apertou = false;
		}
	}
