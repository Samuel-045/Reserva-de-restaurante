...
public class TelaCadastroCliente {
	...
	public TelaCadastroCliente(boolean ligaTela,String size) throws MalformedURLException{
		...
		barraCadastro.setBorder(null);
		barraCadastro.setForeground(Color.black);

		//cria a label de login
		labelCadastro = criaLabel(barraCadastro.getWidth()/2+-60, 10, 250, 30, "labelCadastro" , "Cadastro Cliente");
		...
		botaoCadastrar = criaBotao(frame.getWidth()/2-frame.getWidth()/7, frame.getHeight()/2+frame.getHeight()/3,280,40,"botaoCadastrar", "Entrar");
		//Adiciona os campos em um painel
	...
	private void maximiza(ActionEvent actionEvent) {
		if (apertou == false) {
			...
			conteudoMeioDaTela.setBounds(localizacaoX, frame.getWidth()/10, frame.getWidth()-250, frame.getHeight()-380);
...
//			cria uma variável que altera o eixo x de forma dinâmica
			...
			int localizacaoX3 = ( barraCadastro.getWidth() - (barraCadastro.getWidth()/6) ) /2;
			...
			botaoCadastrar.setBounds(frame.getWidth()/2-frame.getWidth()/7, frame.getHeight()/2+frame.getHeight()/3,280,40);
			barraCadastro.setBounds(frame.getWidth()/2-frame.getWidth()/4,30,frame.getWidth()/2,50);
			labelCadastro.setLocation(barraCadastro.getWidth()/2+-60, 10);
			...
			evento = new java.awt.event.MouseAdapter() {
				public void mouseEntered(java.awt.event.MouseEvent evt) {
				 ...
				 public void mouseClicked(java.awt.event.MouseEvent evt) {
						...
						if(ok==true) {
							Cliente cliente = new Cliente(campoNome.getText(),campoCPF.getText(),campoEmail.getText(),campoSenha.getText(),campoEndereco.getText());
							clienteTela=cliente;
					    	cliente.cadastraBanco();
