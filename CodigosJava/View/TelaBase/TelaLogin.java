...
public class TelaLogin {
	...
	public TelaLogin(boolean Ligatela,String size) throws MalformedURLException {
	...
	public void maximiza(ActionEvent actionEvent) {
		if (apertou == false) {
			...
			novaBarra.setBounds(0, 0, frame.getWidth(), 40);
			botoesMeio.setBounds(0, 40, frame.getWidth(), frame.getHeight());
			botaoEntrar.setBounds(botoesMeio.getWidth() / 2 - 180, botoesMeio.getHeight() / 2 + 30, 400, 40);
			administrador.setBounds(botoesMeio.getWidth() / 2 - 180, botoesMeio.getHeight() / 2 + 70, 400, 40);
			botaoCadastrar.setBounds(botoesMeio.getWidth() / 2 - 180, botoesMeio.getHeight() / 2 - 30, 400, 40);
	...
	public MouseAdapter eventoMouse(JButton botao) {
		...
		if(botao.getName().equalsIgnoreCase("fecha") || botao.getName().equalsIgnoreCase("maximo") || botao.getName().equalsIgnoreCase("minimo")){
			...
			evento =new java.awt.event.MouseAdapter() {
			    ...
			    public void mouseClicked(java.awt.event.MouseEvent evt) {
			    	...
			    	if(frame.getExtendedState()==(JFrame.MAXIMIZED_BOTH)){
				    	try {
				    		TelaCadastroCliente telacliente = new TelaCadastroCliente(true,"Max");
			    		...
			    		try {
			    			TelaCadastroCliente telacliente = new TelaCadastroCliente(true,"Minimo");
						} catch (MalformedURLException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						}	
		...
		}else if(botao.getName().equalsIgnoreCase("botaoEntrar")) {
			evento =new java.awt.event.MouseAdapter() {
			    public void mouseEntered(java.awt.event.MouseEvent evt) {
			    	botao.setBackground(Color.white);
					botao.setForeground(Color.black);
			    ...
			    public void mouseClicked(java.awt.event.MouseEvent evt) {
			    	...
			    	if(frame.getExtendedState()==(JFrame.MAXIMIZED_BOTH)){
				    	try {
				    		TelaLoginCliente telacliente= new TelaLoginCliente(true,"Max");
						} catch (MalformedURLException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						}	
			    		...
			    		try {
			    			TelaLoginCliente telacliente= new TelaLoginCliente(true,"Minimo");
						} catch (MalformedURLException e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						}	
			...
			evento =new java.awt.event.MouseAdapter() {
				    ...
				    public void mouseClicked(java.awt.event.MouseEvent evt) {
				    	...
				    	if(frame.getExtendedState()==(JFrame.MAXIMIZED_BOTH)){
					    	try {
								TelaLoginADM teladm = new TelaLoginADM(true,"max");
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
				    		...
				    		try {
								TelaLoginADM teladm = new TelaLoginADM(true,"minimo");
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
