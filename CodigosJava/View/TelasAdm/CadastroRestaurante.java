...
public class CadastroRestaurante {
	...
	public CadastroRestaurante(boolean ligaTela,String size) throws MalformedURLException {
		...
		labelCadastro = criaLabel(barraCadastro.getWidth()/2+-80, 10, barraCadastro.getWidth()/3, 30, "labelCadastro" , "Cadastrar Restaurante");
...
//		scrollPane.setBorder(null);
		...
		botaoCadastrar = criaBotao(localizacaoX1, 890, 190, 30, "botaoCadastrar", "Cadastrar");
		...
		if(botao.getName().equalsIgnoreCase("fecha") || botao.getName().equalsIgnoreCase("maximo") || botao.getName().equalsIgnoreCase("minimo")){
			...
			evento = new java.awt.event.MouseAdapter() {
				...
				public void mouseClicked(java.awt.event.MouseEvent evt) {
					...
					if(ok==true) {
						Restaurante restaurante = new Restaurante(campoNome.getText(),campoEndereco.getText(),campoChef.getText(),  Integer.parseInt(campoEstrelas.getText()),campoDescricao.getText(),campoDescricaoExperienciaBasica.getText(),campoDescricaoExperienciaCompleta.getText(),campoDescricaoExperienciaVip.getText(),campoUrl.getText());
				    	restaurante.cadastraBanco();
