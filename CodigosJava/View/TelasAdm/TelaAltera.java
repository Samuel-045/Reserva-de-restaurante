...
JLabel containerStrelas = new JLabel();
	...
	public TelaAltera(boolean ligaTela,String size) throws MalformedURLException {
		...
		restaurante.addMouseListener(eventoMouseRestaurante(restaurante,restAltera));
	...
	public MouseAdapter eventoMouseRestaurante(JPanel p, Restaurante restaurante) {
				...
				public void mouseClicked(java.awt.event.MouseEvent evt) {
					if(nomeRestaurante.getText().isEmpty()) {
						...
						BuscaRestaurante rest = new BuscaRestaurante();
						   ...
						   r=rest.BuscaAlt(nPesquisar.getText());
						frame.dispose();
				    	if(frame.getExtendedState()==(JFrame.MAXIMIZED_BOTH)){
					    	try {
					    		AlterRest tela = new AlterRest(true, "Max",r,nPesquisar.getText());
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
				    		...
				    		try {
				    			AlterRest tela = new AlterRest(true, "minimo",r,nPesquisar.getText());
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
