...
public class TelaMenuAdm {
	...
	public TelaMenuAdm(boolean ligaTela,String size) throws MalformedURLException{
		...
		panelImagem.setBounds(botoesMeio.getWidth() / 2 - 100, botoesMeio.getHeight() / 2 + -200, 200, 200);
		...
		public void maximiza(ActionEvent actionEvent) {
			if (apertou == false) {
				...
				novaBarra.setBounds(0, 0, frame.getWidth(), 40);
				botoesMeio.setBounds(0, 40, frame.getWidth(), frame.getHeight());
				relatorioReservas.setBounds(botoesMeio.getWidth() / 2 - 180, botoesMeio.getHeight() / 2 +110, 400, 40);
				botaoExcluir.setBounds(botoesMeio.getWidth() / 2 - 180, botoesMeio.getHeight() / 2 +30, 400, 40);
				botaoAlterar.setBounds(botoesMeio.getWidth() / 2 - 180, botoesMeio.getHeight() / 2 + 70, 400, 40);
				botaoCadastrar.setBounds(botoesMeio.getWidth() / 2 - 180, botoesMeio.getHeight() / 2 - 10, 400, 40);
				panelImagem.setBounds(botoesMeio.getWidth() / 2 - 130, botoesMeio.getHeight() / 2 -250, 300, 200);
				maximo.setText("❐");
				apertou = true;
			} else {
				frame.setSize(1000, 600);
		...
		public MouseAdapter eventoMouse(JButton botao) {
				...
				evento =new java.awt.event.MouseAdapter() {
				    ...
				    public void mouseClicked(java.awt.event.MouseEvent evt) {
				    	...
				    	if(frame.getExtendedState()==(JFrame.MAXIMIZED_BOTH)){
					    	try {
					    	CadastroRestaurante tela = new CadastroRestaurante(true,"Max");
				    		...
				    		try {
				    			CadastroRestaurante tela = new CadastroRestaurante(true,"Minimo");
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
			...
			}else if(botao.getName().equalsIgnoreCase("relatorioReservas")) {
				evento =new java.awt.event.MouseAdapter() {
				    public void mouseEntered(java.awt.event.MouseEvent evt) {
				    	botao.setBackground(Color.white);
						botao.setForeground(Color.black);
				    ...
				    public void mouseClicked(java.awt.event.MouseEvent evt) {
				    	...
				    	if(frame.getExtendedState()==(JFrame.MAXIMIZED_BOTH)){
					    	try {
								RelatorioReservas tela = new RelatorioReservas(true,"Max");
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
				    		...
				    		try {
								RelatorioReservas tela = new RelatorioReservas(true,"Minimo");
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
			...
			}else if(botao.getName().equalsIgnoreCase("botaoAlterar")) {
				evento =new java.awt.event.MouseAdapter() {
				    public void mouseEntered(java.awt.event.MouseEvent evt) {
				    	botao.setBackground(Color.white);
						botao.setForeground(Color.black);
				    ...
				    public void mouseClicked(java.awt.event.MouseEvent evt) {
				    	...
				    	if(frame.getExtendedState()==(JFrame.MAXIMIZED_BOTH)){
					    	try {
					    	TelaAltera tela = new TelaAltera(true,"Max");
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
				    		...
				    		try {
				    			TelaAltera tela = new TelaAltera(true,"Minimo");
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
			...
			}else if(botao.getName().equalsIgnoreCase("botaoExcluir")) {
				evento =new java.awt.event.MouseAdapter() {
				    public void mouseEntered(java.awt.event.MouseEvent evt) {
				    	botao.setBackground(Color.white);
						botao.setForeground(Color.black);
				    ...
				    public void mouseClicked(java.awt.event.MouseEvent evt) {
				    	...
				    	if(frame.getExtendedState()==(JFrame.MAXIMIZED_BOTH)){
					    	try {
					    TelaExclui tela = new TelaExclui(true,"Max");
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
				    		...
				    		try {
				    			TelaExclui tela = new TelaExclui(true,"Minimo");
							} catch (MalformedURLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}	
